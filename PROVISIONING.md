...
```
ln -s /etc/letsencrypt/live/example.com/fullchain.pem /etc/ssl/blog.crt
ln -s /etc/letsencrypt/live/example.com/privkey.pem /etc/ssl/blog.key
```
...
```
9 5,17 * * * /opt/certbot/certbot-auto renew --quiet --no-self-upgrade --webroot-path /home/deployer/apps/blog/shared/public/
```
