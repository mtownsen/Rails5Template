...
sudo service unicorn_blog <start|stop|restart>
sudo service sidekiq_blog <start|stop>
```
...
```
sudo service unicorn_blog restart
sudo service sidekiq_blog stop
sudo service sidekiq_blog start
```
